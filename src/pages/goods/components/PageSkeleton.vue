<template name="skeleton">
  <view class="sk-container">
    <scroll-view :scroll-y="true" class="viewport" :enable-back-to-top="true">
      <view class="goods">
        <view class="preview">
        ...
        <view class="meta">
          <view class="price">
            ...
            <text class="number sk-transparent sk-text-14-2857-626 sk-text">1499.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-962 sk-text"
            >飞天53%vol500ml贵州茅台酒（带杯）</view
          >
          <view class="desc sk-transparent sk-text-0-0000-336 sk-text">茅台飘香，正品溯源app</view>
        </view>
        <view class="action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-168 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-783 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-894 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-262 sk-text">
              请选择收获地址
            </text>
          </view>
    ...
    <view class="toolbar" style="padding-bottom: 0px">
      <view class="icons">
      ...
      <view class="buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-305 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-358 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
