...
const onGetphonenumberSimple = async () => {
  const res = await postLoginWxMinSimpleAPI('15616975501')
  login(res.result)
}

const login = (profile: LoginResult) => {
  // 保存会员信息
  ...
  <view class="viewport">
    ...
    <view class="login">
      ...
      <view class="extra">
        ...
        <view class="options">
          <button open-type="getPhoneNumber" @getphonenumber="onGetphonenumberSimple">
